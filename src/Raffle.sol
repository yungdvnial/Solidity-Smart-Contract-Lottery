...
contract Raffle is VRFConsumerBaseV2 {
    ...
    address payable[] private s_players; //payable because we need to pay the player ETH when they win
    ...
    constructor(
        ...
        s_lastTimeStamp = block.timestamp; //starting timestamp
    }
    ...
    function checkUpKeep(
        ...
        bool isOpen = (RaffleState.OPEN == s_raffleState); // raffle is open
    ...
    function performUpKeep(bytes calldata /* performData */) external {
        ...
        // contract -> ChainLink VRF (request)
    ...
    // function design architecture: CEI - Checks, Effects, Interactions
    function fulfillRandomWords(
        ...
        // Reset raffle
        s_raffleState = RaffleState.OPEN;
        s_players = new address payable[](0); // array with size 0
